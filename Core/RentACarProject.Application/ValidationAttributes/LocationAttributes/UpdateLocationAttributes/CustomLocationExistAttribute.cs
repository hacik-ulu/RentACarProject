...
namespace RentACarProject.Application.ValidationAttributes.LocationAttributes.UpdateLocationAttributes
{
    public class CustomLocationExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (UpdateLocationCommand)validationContext.ObjectInstance;
