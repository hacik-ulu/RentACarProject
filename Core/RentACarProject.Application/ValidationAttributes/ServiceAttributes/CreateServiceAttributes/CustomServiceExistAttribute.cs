...
namespace RentACarProject.Application.ValidationAttributes.ServiceAttributes.CreateServiceAttributes
{
    public class CustomServiceExistAttribute :ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (CreateServiceCommand)validationContext.ObjectInstance;
