...
namespace RentACarProject.Application.ValidationAttributes.AuthorAttributes.UpdateAuthorAttributes
{
    public class CustomAuthorExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (UpdateAuthorCommand)validationContext.ObjectInstance;
