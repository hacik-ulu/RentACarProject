...
namespace RentACarProject.Dto.ValidationAttributes.CategoryAttributes.CreateCategoryAttributes
{
    public class CustomCategoryExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (CreateCategoryDto)validationContext.ObjectInstance;
