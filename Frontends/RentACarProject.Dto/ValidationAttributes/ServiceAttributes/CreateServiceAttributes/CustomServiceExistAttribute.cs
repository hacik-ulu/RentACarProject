...
namespace RentACarProject.Dto.ValidationAttributes.ServiceAttributes.CreateServiceAttributes
{
    public class CustomServiceExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (CreateServiceDto)validationContext.ObjectInstance;
