...
namespace RentACarProject.Dto.ValidationAttributes.FeatureAttributes.UpdateFeatureAttributes
{
    public class CustomFeatureExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (UpdateFeatureDto)validationContext.ObjectInstance;
