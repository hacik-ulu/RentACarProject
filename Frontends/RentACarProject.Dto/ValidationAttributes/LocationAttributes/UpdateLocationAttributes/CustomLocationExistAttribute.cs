...
namespace RentACarProject.Dto.ValidationAttributes.LocationAttributes.UpdateLocationAttributes
{
    public class CustomLocationExistAttribute :ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (UpdateLocationDto)validationContext.ObjectInstance;
