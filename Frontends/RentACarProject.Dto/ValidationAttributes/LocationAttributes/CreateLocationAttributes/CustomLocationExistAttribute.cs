...
namespace RentACarProject.Dto.ValidationAttributes.LocationAttributes.CreateLocationAttributes
{
    public class CustomLocationExistAttribute :ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (CreateLocationDto)validationContext.ObjectInstance;
