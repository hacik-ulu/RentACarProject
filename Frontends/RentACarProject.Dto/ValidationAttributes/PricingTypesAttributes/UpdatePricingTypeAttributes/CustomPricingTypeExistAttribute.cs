...
namespace RentACarProject.Dto.ValidationAttributes.PricingTypesAttributes.UpdatePricingTypeAttributes
{
    public class CustomPricingTypeExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (UpdatePricingDto)validationContext.ObjectInstance;
