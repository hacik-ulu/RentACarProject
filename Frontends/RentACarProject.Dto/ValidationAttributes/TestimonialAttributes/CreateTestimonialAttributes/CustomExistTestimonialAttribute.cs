...
namespace RentACarProject.Dto.ValidationAttributes.TestimonialAttributes.CreateTestimonialAttributes
{
    public class CustomTestimonialExistAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var command = (CreateTestimonialDto)validationContext.ObjectInstance;
